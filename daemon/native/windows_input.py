...
VK = {
    "BACKSPACE":0x08,"TAB":0x09,"ENTER":0x0D,"SHIFT":0x10,"CONTROL":0x11,"CTRL":0x11,
    "ALT":0x12,"ESCAPE":0x1B,"ESC":0x1B,"SPACE":0x20,"PAGEUP":0x21,"PAGEDOWN":0x22,
    "END":0x23,"HOME":0x24,"ARROWLEFT":0x25,"ARROWUP":0x26,"ARROWRIGHT":0x27,"ARROWDOWN":0x28,
    "INSERT":0x2D,"DELETE":0x2E,"META":0x5B,"WIN":0x5B,"EQUAL":0xBB,"PLUS":0xBB,"MINUS":0xBD,
...
def main():
    if len(sys.argv)<2:
        print("usage: windows_input.py combo|key|text [VALUE via stdin]",file=sys.stderr); return 2
