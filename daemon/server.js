...
module.exports={runtime,router,debugAdapter,wss,auth,controller,runtimeLock,handleBrainMessage,CONTROL_PROTOCOL_VERSION,EXTENSION_PROTOCOL_VERSIONS,protocolAllowed,browserIdFromHello,requireTaskId,requireBrowserId,guardianOutcomeLabel,disconnectExtensionForRevocation,flushStores,clearEndpoint};
