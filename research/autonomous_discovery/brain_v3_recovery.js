...
class AutonomousYouTubeBrainV3Recovery extends AutonomousYouTubeBrainV3{
  ...
  reportObject(status){const report=super.reportObject(status);report.schemaVersion=6;report.autonomy={...report.autonomy,revision:'evidence_driven_actionability_recovery_v2',safeCandidateClick:'brain_selected_hit_evidence_single_click_v4',candidateBudgetMs:20000,implicitCandidateScrolls:0};report.agent={...(report.agent||{}),diagnostics:historyDiagnostics(this.agentHistory.slice(-250))};return report;}
}
