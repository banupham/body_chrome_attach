...
function parseArgs(argv=process.argv.slice(2)){
  const out={target:null,selftest:false,unlimited:false,continueAfterFound:false,maxMinutes:30,maxSteps:120,maxQueries:24,maxDwellSec:90,reportEverySteps:10,reportEveryMinutes:10,browser:null,tab:null,root:null,browserWaitSec:120,actionRetries:3,verifyTimeoutMs:5500,explorationRate:0.18};
