...
class AutonomousYouTubeBrainV4 extends AutonomousYouTubeBrainV3{
  constructor(config,deps={}){
    super(config,deps);this.autonomyMode='full_body_agent_account_cold_start';this.previewExposureCount=0;this.previewConfirmedCount=0;
  }
