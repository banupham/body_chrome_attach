...
function frontierEligible(family=''){
  return family==='search_query'||family==='home_nav'||family==='topic_filter'||/^(?:preview_|search_neighbor|home_neighbor|related_|mix_neighbor|candidate_)/.test(family);
}
