...
assert.ok(observation.required.includes('browserUi'));
assert.equal(Object.prototype.hasOwnProperty.call(observation.properties,'environment'),false);
assert.ok(observation.properties.bodyState.required.includes('online'));
assert.equal(observation.properties.bodyState.required.includes('browserState'),false);
