...
const targetSearch={videoId:'target001',surface:'search_results',position:1,targetMatch:true,targetProximity:1,visible:true,actionable:true,hitTested:true,actionPoint:{x:160,y:190},visibleRect:{x:10,y:100,width:300,height:180,centerX:160,centerY:190},actionRect:{x:10,y:100,width:300,height:180,centerX:160,centerY:190},evidence:{geometryKnown:true,rectIntersectsViewport:true,hitOwned:true},mediaFormat:{kind:'LONG_FORM'},topic:'real_estate'};
const neighbor={videoId:'neighbor001',surface:'search_results',position:2,targetMatch:false,targetProximity:.55,visible:true,actionable:true,hitTested:true,actionPoint:{x:160,y:410},visibleRect:{x:10,y:320,width:300,height:180,centerX:160,centerY:410},actionRect:{x:10,y:320,width:300,height:180,centerX:160,centerY:410},evidence:{geometryKnown:true,rectIntersectsViewport:true,hitOwned:true},mediaFormat:{kind:'LONG_FORM'},topic:'real_estate'};
