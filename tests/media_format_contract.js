...
async function main(){
  ...
  const snapshot={pageType:'shorts',currentVideoId:'current-short',currentTopic:'real_estate',currentMediaFormat:shortFormat,candidates:[
    {videoId:'short-candidate',path:'/shorts/short-candidate',surface:'related',position:1,visible:true,actionable:true,hitTested:true,actionPoint:{x:110,y:120},visibleRect:{x:10,y:80,width:200,height:80,centerX:110,centerY:120},actionRect:{x:10,y:80,width:200,height:80},evidence:{geometryKnown:true,rectIntersectsViewport:true,hitOwned:true},classification:{primary:'real_estate',confidence:0.8},targetMatch:false,targetProximity:0.7,youtubeApi:{title:'Short candidate',mediaFormat:shortFormat}},
